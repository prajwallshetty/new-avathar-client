  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 select-none pb-12">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground font-medium mt-1">Draft or publish a search-optimized article to increase organic website SEO ranking.</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-border bg-card shadow-sm rounded-xl overflow-hidden">
            <CardHeader className="p-5 border-b border-border bg-muted/20">
              ...
              <CardDescription className="text-xs text-muted-foreground/80 mt-1">Write your main editorial content here.</CardDescription>
            </CardHeader>
            ...
            <CardContent className="p-5 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  required
                  rows={12}
                  placeholder="Start writing article... Use standard HTML tags like <p>, <h2>, <ul> for rich formatting."
          ...
          <Card className="border-border bg-card shadow-sm rounded-xl overflow-hidden">
            ...
            <CardContent className="p-5 space-y-4">
              ...
              <div className="pt-4 flex gap-2">
                ...
                <Button type="submit" disabled={loading} className="text-xs font-semibold flex-1 gap-1">
